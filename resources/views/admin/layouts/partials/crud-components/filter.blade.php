                ...
                <div class="card">
                    <div class="card-header" style="display: flex; flex-wrap: wrap; justify-content: space-between;">
                        ...
                        <div>
                            ...
                            @endif
                            @if ($pdf_route)
                                <a href="{{ route($pdf_route) }}">
                                    <button href class="btn btn-success m-1 float-end" type="button">
                        ...
                        <div class="collapse" id="filter" style="">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @endforeach
                                    <div class="col-md-3 col-12">
                                        {{ \App\Base\Helper\Field::selectWithSearch(name: 'per_page', label: 'per_page', options: [10 => 10, 20 => 20, 50 => 50, 100 => 100], required: 'false') }}
                                    </div>
                                    <div class="col-md-3 col-12">
