...
<body class="antialiased" style="color:white; text-size;font-size: large;">
        ...
        align-items: center;">
            ...
            ">
                    <ol class="list-decimal list-outside">
                        <li style="display: list-item;list-style: inside">
                            لوريم ايبسوم هو نص شكلي يستخدم في صناعات الطباعة والتنضيد. لقد تم استخدام لوريم ايبسوم في
                            الصناعة
                            منذ القرن الخامس عشر في الطباعة والتنضيد.
                        </li>
                        <li style="display: list-item;list-style: inside">
                            لوريم ايبسوم هو نص شكلي يستخدم في صناعات الطباعة والتنضيد. لقد تم استخدام لوريم ايبسوم في
                            الصناعة
